...
class CreateDevicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('devices', function (Blueprint $table) {
            ...
            $table->string('notification_token', 250)->nullable(); // Ex: Onesignal platform player token.
            $table->string('notification_tags', 250)->nullable(); // Ex: daily, weekly, monthly, premium
